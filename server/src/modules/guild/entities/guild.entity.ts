...
export class Guild {
  ...
  @Column({
    ...
    length: 100,
    nullable: true,
    name: 'kook_verify_token',
    comment: 'KOOK Verify Token',
  })
  ...
  @Column({
    ...
    nullable: true,
    name: 'resupply_rooms',
    comment: '补装房间列表（如 ["1","2",...,"14","大厅一","大厅二"]）',
  })
  ...
  @Column({
    ...
    default: 'sgp',
    name: 'albion_server',
    comment: 'Albion服务器: west/ams/sgp',
  })
  albionServer: string;
  ...
  @Column({
    type: 'datetime',
    nullable: true,
    name: 'albion_members_last_synced_at',
    comment: 'Albion成员最后同步时间',
  })
  albionMembersLastSyncedAt: Date;
  ...
  @Column({
    ...
    comment: '一次性激活码（joined_guild时生成）',
  })
