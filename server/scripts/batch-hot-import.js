...
// 主手武器 P8+P9 含Q4
const WEAPONS = [
  '重型锤杖','守誓双锤','恐惧风暴君主','平衡棍','巨锤','锻造之锤',
  '堕神法杖','堕落法杖','瘟病法杖','灾荒法杖','林语者法杖','天谴法杖',
  '腐败呼唤法杖','熊卫士之击','无尽之剑','尖刺护手','星界法杖','赤炎镰刀',
  '血刃','正义之手大锤','卡姆兰锤杖','锤杖','生咒法杖','断水剑',
  '杰出奥术法杖','玄秘法杖','基石锤杖','黑僧棍','杰出神圣法杖',
  '裂域斧','索魂尖枪','永霜冰棱','暮歌之戒','裂隙刺刀','长弓',
  '炼狱火之手','鹭鸶长矛','塑能炮','遏怒拳刃','阿瓦隆之拳',
  // V2.12.2 新增变身法杖
  '潜行者法杖','林语者法杖','原始野性法杖','血月法杖',
  '炼狱裂隙法杖','大地符文法杖','唤光者法杖','凝视法杖',
];

// 副手 P8+P9 含Q4
const OFFHANDS = ['唤雾号角','盾牌','血牌','茔烛','狗链','邪杖'];

// 甲 P8+P9 不含Q4
const ARMORS = [
  '守卫盔甲','骑士盔甲','恶魔盔甲','士兵盔甲','纯洁长袍','牧师长袍',
  '喧嚣外套','审判盔甲','邪教徒长袍','坚韧外套','猎人外套','风墙甲',
  '皇家外套','学士长袍',
];

// 鞋 P8+P9 不含Q4
const SHOES = [
  '雇佣兵鞋子','邪教徒便鞋','德鲁伊便鞋','皇家便鞋',
  '守墓人长靴','英勇长靴','牧师便鞋','猎人鞋子',
];
...
// 食物 Q1~Q3
const FOODS = ['猪肉鸡蛋饼','牛肉三明治','阿瓦隆猪肉鸡蛋饼','阿瓦隆牛肉三明治','炖牛肉','尘洞螃蟹蛋饼','猪肉蛋饼'];
