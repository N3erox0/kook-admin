...
| **V3.0.1** | **登录页精简** | | | |
| F-307 | 登录页移除KOOK登录按钮 | completed | 2026-05-19 | 精简登录布局 |
| **V3.0.2** | **测试反馈修复** | | | |
| F-308 | 库存按钮并排 | completed | 2026-05-22 | 顶部按钮区调整 |
| F-309 | KOOK消息轮询改4次 | completed | 2026-05-22 | 08:00/12:00/18:00/23:00 |
| F-310 | Albion快速绑定弹窗 | completed | 2026-05-22 | GuildSettings 页 |
| F-311 | 装备库存录入改行内编辑 | completed | 2026-05-22 | 替代 Modal 弹窗 |
| F-312 | Albion绑定去手动表单+roles 500修复 | completed | 2026-05-22 | 仅保留快速绑定 |
| F-313 | 装备库存录入改行内编辑 | completed | 2026-05-22 | （重） |
| F-314 | 补装去重重新启用 | completed | 2026-05-22 | 修复重复记录根因 |
| **V3.1** | **战报展示与拉取稳定性** | | | |
| F-315 | 战报页面列优化 | completed | 2026-05-30 | 列宽/装备数显示 |
| F-316 | 战报装备中文名显示 | completed | 2026-05-30 | 命中参考库优先显示中文名 |
| F-317 | 战报拉取try/catch移到单事件级别 | completed | 2026-05-30 | 单事件失败不影响整公会 |
| F-318 | 战报拉取改异步+前端提示优化 | completed | 2026-05-30 | 避免 nginx 60s 超时 |
| **V3.2** | **简化+战报增量拉取改造** | | | |
| F-319 | 公会侧菜单精简为4项 | completed | 2026-06-03 | 控制台/成员/装备库存/补装管理 |
| F-320 | 仪表盘新增"管理入口区"卡片网格 | completed | 2026-06-03 | 公会设置/库存预警/战报记录/操作日志/登录账号 |
| F-321 | 隐藏菜单的路由保留 | completed | 2026-06-03 | 兼容旧链接和书签 |
| F-322 | 新增 accounts 模块（公会维度账号管理） | completed | 2026-06-03 | /api/guild/:guildId/accounts，仅超管 |
| F-323 | 登录账号列表合并查询 | completed | 2026-06-03 | KOOK登录/邀请码/KOOK同步/手动创建 4 来源 |
| F-324 | 手动创建登录账号 | completed | 2026-06-03 | 账密+创建即绑公会，伪 KOOK ID 占位 |
| F-325 | 账号改角色/启停/重置密码 | completed | 2026-06-03 | 仅手动账号可重置密码 |
| F-326 | 成员列表隐藏KOOK Tab | completed | 2026-06-03 | 仅显示公会成员（Albion） |
| F-327 | 修复"录入库存"按钮失效 | completed | 2026-06-03 | 录入区从Card内移到Card外独立蓝色框，更醒目 |
| F-328 | CSV导入改为 Modal 弹窗 | completed | 2026-06-03 | 拖拽+模板下载统一在 Modal 内 |
| F-329 | 装备库存导出CSV | completed | 2026-06-03 | 列：装备名/等级/品质/装等/部位/数量/位置/更新时间，UTF-8 BOM |
| F-330 | 导出全选 Switch | completed | 2026-06-03 | 开=全量；关=按当前筛选条件 |
| F-331 | 战报 Cron 时区固定为 Asia/Shanghai | completed | 2026-06-03 | 修复 V3.0 实际跑早 10:00 的 BUG |
| F-332 | 全部 Cron 加东八区时区注解 | completed | 2026-06-03 | 成员同步/库存预警/死亡预警/装备热度/KOOK频道 |
| F-333 | 战报增量分页拉取 | completed | 2026-06-03 | 取本地最大 deathTime 水位线，每页51条循环 |
| F-334 | 战报入库改 INSERT IGNORE | completed | 2026-06-03 | typeorm .insert().orIgnore()，消除并发 WARN |
| F-335 | 战报手动触发并发锁 | completed | 2026-06-03 | 进程内 Set 锁，同公会拒绝重复运行 |
| F-336 | 战报单成员失败重试1次+超时30分钟 | completed | 2026-06-03 | 间隔 2s 重试 |
| F-337 | 战报展开行按10部位分组 | completed | 2026-06-03 | 武器/副手/头/甲/鞋/披风/坐骑/药水/食物/背包 |
